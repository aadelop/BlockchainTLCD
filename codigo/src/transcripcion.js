 ...
 * @transaction
 */
function supervisorAsignado(supervisorAsignado) {
 ...
 * @transaction
 */
function transcriptorAsignado(transcriptorAsignado) {
 ...
 * 
 * @param {org.usb.library.programs.ValidarTranscripcion} validarTranscrip - the ValidarTranscripcion transaction
 * @transaction
 */
function validarTranscripcion (transcripPorValidar){
 ...
 * como programa 
 * 
 * @param {org.usb.library.programs.AprobarTranscripcion} aprobarTranscrip - the AprobarTRanscripcion transaction
 * @transaction
 */
function aprobarTranscripcion (transcripAprobada){
 ...
 * 
 * @param {org.usb.library.programs.RevisionTranscripcion} enviarRevision - the RevisionTranscripcion transaction
 * @transaction
 */

function revisionTranscripcion(revisionTranscrip){
 ...
 * @param {org.usb.library.programs.ObservacionTranscripcion} enviarObservacion - the ObservacionTranscripcion transaction
 * @transaction
 */

function observacionTranscripcion(observacionTranscrip){
